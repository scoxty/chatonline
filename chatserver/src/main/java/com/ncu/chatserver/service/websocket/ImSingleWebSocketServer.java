package com.ncu.chatserver.service.websocket;

import cn.hutool.core.date.DateUtil;
import cn.hutool.json.JSONUtil;
import com.ncu.chatserver.entity.ImSingle;
import com.ncu.chatserver.service.ImSingleService;
...
@Component
public class ImSingleWebSocketServer implements InitializingBean {
    private static final Logger log = LoggerFactory.getLogger(ImSingleWebSocketServer.class);
    /**
     * 记录当前在线连接数
     */
